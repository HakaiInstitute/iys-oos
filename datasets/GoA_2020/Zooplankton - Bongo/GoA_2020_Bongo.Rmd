...
Now we need to read in the Excel file and the correct sheets we want to work with. In the Excel file there are two sheets that we want to work with, one that includes additional metadata information, such as data on tow distance and volume of water filtered, whereas the other sheet includes taxonomic occurrences of Zooplankton in the bongo net. 
