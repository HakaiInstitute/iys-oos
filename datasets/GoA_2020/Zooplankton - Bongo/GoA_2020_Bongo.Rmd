...
The event Core consists of a hierarchical structure with four layers: `project`, `cruise`, `station` and `cast`. Each layer has different information associated to it. `sampleSizeValue` and `sampleSizeUnit` are not included 
...
Next, we start the taxon matching procedure. 
