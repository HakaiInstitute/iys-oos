...
**However, for phaeopigment concentration I have not yet been able to find standardized vocabulary in CF Conventions - perhaps there is another naming convention that can be applied?**. 
...
chl_erddap <- pivot_wider(chl_erddap, names_from = measurementType,
  ...
  rename(Chl = `chlorophyll a`,
         Phe = phaeopigments) %>%
  mutate(mass_concentration_of_chlorophyll_a_in_sea_water = paste(Chl, measurementUnit),
         phaeopigment_concentration = paste(Phe, measurementUnit))
```
