...
# First, EC25 is measured in microSiemens/cm, which is not (yet) in NERCs controlled vocabulary. Therefore, we convert this column to milliSiemens/cm:
...
__Note: in the previous chunk we got our data from sheet2 - this is data collected at continuous depths. To create a measurement table for sheet1 (discrete depth measurements), simply replace sheet1 with sheet2 in chunk of code above.__

Assign NERC controlled vocabulary to the variables and the measurement units. Finally, save the eMoF table locally and on GoogleDrive in the correct folder.  
