...
__Note: in the previous chunk we got our data from sheet1 - this is data collected at discrete depths (so a subset from the data presented in sheet2). To create a measurement table for sheet2, simply replace sheet1 with sheet2.__
