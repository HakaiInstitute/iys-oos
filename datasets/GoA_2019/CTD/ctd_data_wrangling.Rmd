...
ctd_measurement <- sheet2 %>% 
  ...
  mutate(measurementID = case_when(measurementType == "TEM_S" ~ paste(eventID,"temp_s",sep=":"),
         ...
         measurementTypeID = recode(measurementType, #URIs from NERC website
                                    "seabird_sea_water_temperature" = "http://vocab.nerc.ac.uk/collection/P04/current/G963/",
                                    "rinko_sea_water_temperature" = "http://vocab.nerc.ac.uk/collection/P04/current/G963/",
                                    "rinko_sea_water_practical_salinity" = "http://vocab.nerc.ac.uk/collection/P04/current/G995/",
                                    "seabird_sea_water_practical_salinity" = "http://vocab.nerc.ac.uk/collection/P04/current/G995/",
                                    "sea_water_electrical_conductivity" = "http://vocab.nerc.ac.uk/collection/P01/current/CNDCZZ01/",
