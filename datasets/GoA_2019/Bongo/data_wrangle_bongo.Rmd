...
col_order <- c("eventID", "parentEventID", "eventDate", "year", "month", "day", "decimalLatitude", "decimalLongitude", "footprintWKT", "coordinateUncertaintyInMeters", "minimumDepthInMeters", "maximumDepthInMeters", "geodeticDatum", "type", "eventRemarks")
...
bongo2019_occ_core <- bongo2019_occ_fnl %>%
  ...
  select(eventID, occurrenceID, scientificName, 
         scientificNameID = lsid, 
         parentNameUsageID,
         kingdom, phylum, class, order, family, genus, occurrenceStatus, Preparations, occurrenceRemarks)
