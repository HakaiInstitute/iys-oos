...
The raw data is stored on GoogleDrive. The first step is to download the files from Google Drive to a local folder on your computer's hard drive. 
...
<div class = "blue">
Q: Where do we draw the line when it comes to associating a taxonomic occurrence record (occurrenceID) to an entry? 
</div>
