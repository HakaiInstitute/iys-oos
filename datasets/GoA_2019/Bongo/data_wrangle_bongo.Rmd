...
In our extended measurementOrFact table(s), we associate sampling measurements and effort to either `eventID`, and biometric measurements to the `occurrenceID`. 
...
Biometric measurements are associated to the `occurrenceID`: 
