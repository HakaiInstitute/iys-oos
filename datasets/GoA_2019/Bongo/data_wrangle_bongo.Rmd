...
bongo_emof <- bongo_emof %>%
  ...
  mutate_all(as.character) %>%
  pivot_longer(cols = number:bongo_opening, 
               names_to = "measurementType",
               values_to = "measurementValue") %>%
  mutate(
    measurementID = case_when(
      ...
      measurementType == "bongo_mesh" ~ paste(eventID, "bongo_mesh_size", sep = ":"),
      measurementType == "bongo_opening" ~ paste(eventID, "bongo_opening", sep = ":")
