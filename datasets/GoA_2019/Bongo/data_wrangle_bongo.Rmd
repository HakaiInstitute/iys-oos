...
bongo2019_abun <- subset(bongo2019_abun, date >= "2019-02-19" & date <= "2019-03-15") %>%
  mutate(project = "IYS",
         cruise = paste(project, "GoA2019", sep = ":"),
         station = paste(cruise, station, sep = "_Stn"),
         # Confirm that abundance / community analysis only done from Net 1. 
...
The second eMOF core we create is for the abundance / community analysis study, which is from the bongo2019_abun dataframe: 
...
bongo_emof_abun <- bongo2019_abun %>%
  ...
  mutate(
    ...
    measurementTypeID = case_when(
      ...
      measurementType == "abund_m3_flow_est" ~ " ",
      measurementType == "abund_m3_depth_est" ~ " "), 
    measurementUnit = case_when(
