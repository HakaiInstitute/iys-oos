...
# What to do with the column 'digested_food"?

# To do: populate the following chunk of code with WoRMS URN: 
boreoteuthis_borealis == "urn:lsid:marinespecies.org:taxname:342326",
# Boreoteuthis is not an accepted genus, Gonatopsis is the accepted version?
neocalanus_cristatus == "urn:lsid:marinespecies.org:taxname:104470",
pisces == "urn:lsid:marinespecies.org:taxname:1167",
tomopteris == "urn:lsid:marinespecies.org:taxname:11676",
chuneola_major == "urn:lsid:marinespecies.org:taxname:431286" ,
sergestes_pacificus == " ",
# Is only the atlantic version accepted?
e_pacifica == "urn:lsid:marinespecies.org:taxname:237851",
