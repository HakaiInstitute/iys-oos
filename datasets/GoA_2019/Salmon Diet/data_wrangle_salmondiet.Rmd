...
Create a resourceRelationship extension, and save locally:
...
write_csv(salmondiet_resourceRelationship, here("Salmon Diet", "tidy_data", "salmondiet__resourceRelationship.csv"))
```

And add `associatedTaxa` and `associatedOccurrence` to the Occurrence extension, and save locally: 
...
diet2019_occ <- diet2019_occ %>%
  mutate(associatedTaxa = ifelse(grepl("pr", diet2019_occ$occurrenceID), 
         ...
         associatedOccurrence = ifelse(grepl("-pr", diet2019_occ$occurrenceID), 
                                       paste('"prey of"', " : ", '"', diet2019_occ$eventID, ":", diet2019_occ$species, ":", diet2019_occ$pred_id, "-p", '"', sep = ""), ""))
