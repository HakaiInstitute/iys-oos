...
salmon_trawl <- salmon_trawl %>% dplyr::select(-decimalLatitude, -decimalLongitude)

coordinates <- obistools::calculate_centroid(salmon_trawl$footprintWKT)
salmon_trawl <- cbind(salmon_trawl, coordinates)
