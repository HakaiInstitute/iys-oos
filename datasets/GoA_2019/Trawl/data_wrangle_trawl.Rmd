...
Create a separate dataframe with the location of the stations. We check for the unique NUMBERs (we assume that these are synonymous with "Station") with associated Lat/Long. We need to confirm that this is the case, as there are a reported 63 unique trawl numbers, whereas there are only 60 stations?
