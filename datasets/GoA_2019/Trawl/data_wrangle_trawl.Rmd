...
# Check for the number of unique NUMBERs with associated Lat/Long:
unique_trawl <- unique(trawl[c("NUMBER","X","Y")])
```

As noted before, there are 63 unique NUMBERs recorded, with unique lat and longs. Later, these coordinates will be plotted and cross-referenced to station coordinates recorded in other data sets to understand any discrepancies. Therefore, a .csv table is created with unique coordinates:

``` {r trawl_location, eval = FALSE}
