...
trawl2019_ind_emof <- trawl2019_catch_ind_occ %>%
  select(occurrenceID,
         ...
         `LENGTH GONADd (niG-GL-LEN)`, `WIDTH GONAD (NID-GI-WID)`,
         `liver weight (MPECH)`, `gonad weight (MGON)`) %>%
  ...
  mutate(measurementType = recode(measurementType,
                                  ...
                                  `LENGTH GONADd (niG-GL-LEN)` = "length_gonad",
                                  `WIDTH GONAD (NID-GI-LEN)` = "width_gonad",
                                  `liver weight (MPECH)` = "liver_weight",
                                  `gonad weight (MGON)` = "gonad_weight"),
         measurementID = case_when(
           ...
           measurementType == "length_gonad" ~ paste(occurrenceID, "length_gonad", sep = "-"),
           measurementType == "width_gonad" ~ paste(occurrenceID, "width_gonad", sep = "-"),
           measurementType == "liver_weight" ~ paste(occurrenceID, "liver_weight", sep = "-"),
           measurementType == "gonad_weight" ~ paste(occurrenceID, "gonad_weight", sep = "-")),
         measurementTypeID = case_when(
           ...
           measurementType == "length_gonad" ~ " ",
           measurementType == "width_gonad" ~ " ",
           measurementType == "liver_weight" ~ " ",
           measurementType == "gonad_weight" ~ " "),
         measurementUnit = case_when(
           measurementType == "species length" ~ "millimeters",
           measurementType == "Standard length" ~ "millimeters",
           measurementType == "length_gonad" ~ "millimeters",
           measurementType == "width_gonad" ~ "millimeters",
           measurementType == "liver_weight" ~ "grams",
           measurementType == "gonad_weight" ~ "grams",
