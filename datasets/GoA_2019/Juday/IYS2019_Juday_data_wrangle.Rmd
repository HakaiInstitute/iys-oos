...
# Make sure the folder path exists already (e.g. ./Salmon Diet/tidy_data)
write_csv(IYS2019_juday_occ, here("Juday", "tidy_data", "juday_occ_summary.csv"))
```
