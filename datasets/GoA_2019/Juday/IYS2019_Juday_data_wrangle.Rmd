...
# For the cast, please note that the longitude was recorded as latitude in the original file, and the latitude recorded as the longitude! Cross-referencing with station coordinates from other datasets confirms this. 
juday_cast <- juday %>%
  select(eventID = cast,
