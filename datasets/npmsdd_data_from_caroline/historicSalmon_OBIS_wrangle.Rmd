...
Should we add a column with `samplingProtocol` and add the link to the paper? Does the paper have a DOI? Perhaps we need to host the paper somewhere, create a DOI and then link to it?
