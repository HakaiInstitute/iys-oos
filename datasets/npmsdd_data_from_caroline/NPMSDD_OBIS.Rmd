...
ScientificNames_prey <- worrms::wm_records_names(scientificnames$scientificName)
ScientificNames_prey <- dplyr::bind_rows(ScientificNames_prey) %>% filter(status == "accepted")
...
ScientificNames_prey <- plyr::rbind.fill(ScientificNames_prey, Coelenterata)
...
ScientificNames_prey <- ScientificNames_prey[!ScientificNames_prey$AphiaID == "163921",]
ScientificNames_prey <- ScientificNames_prey %>% 
...
prey_occ <- left_join(NPMSDD_occ, ScientificNames_prey, by = "scientificName")
...
# Bind rows of both prey_occ and predator_occ to form Occurrence Core. 
