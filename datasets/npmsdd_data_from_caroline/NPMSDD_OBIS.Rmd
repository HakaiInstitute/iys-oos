...
# Manual examination indicates that only the observation of Coelenterata needs to be populated manually:
scientificnames$scientificNameID[scientificnames$Species == "Coelenterata"] <- "urn:lsid:marinespecies.org:taxname:2"
scientificnames$scientificName[scientificnames$Species == "Coelenterata"] <- "Coelenterata"

x <- taxizesoap::worms_records(scientificnames$scientificName)
...
predator_occ <- NPMSDD_occ %>% 
  dplyr::select(eventID, predator_lowest_taxonomic_level, predator_id, lat_min, lat_max, lon_min, lon_max, 
                ...
                gear_type_predator_id3, gear_type_predator_id4, gear_type_predator_id5, vernacularName) %>%
...
prey_occ <- NPMSDD_occ %>%
    dplyr::select(eventID, occurrenceID, occurrenceStatus, lat_min, lat_max, lon_min, lon_max, year_min, year_max, 
                            ...
                            gear_type_predator_id1, gear_type_predator_id2, gear_type_predator_id3,
                            gear_type_predator_id4, gear_type_predator_id5, vernacularName) %>%
...
NPMSDD_occ <- left_join(NPMSDD_occ, date, by = "occurrenceID") %>%
  select(eventID, occurrenceID, eventDate, verbatimEventDate, year, month, decimalLatitude, decimalLongitude, footprintWKT, coordinateUncertaintyInMeters, scientificName, scientificNameID, vernacularName, occurrenceStatus, kingdom, phylum, class, order, family, genus, specificEpithet, gear_type_predator_id1, gear_type_predator_id2, gear_type_predator_id3, gear_type_predator_id4, gear_type_predator_id5) %>%
