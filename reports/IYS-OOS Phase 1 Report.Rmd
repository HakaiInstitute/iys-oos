...
An agreement was signed between the Hakai Institute and the North Pacific Anadromous Fish Commission on February 3rd, 2020 for Hakai to scope and review the requirements of data management for high seas salmon ecology and oceangraphic observations collected by collaborators of the International Year of the Salmon. We recommend a number of actions and worthwhile considerations for building and delivering digital infrastructure  systems for salmon ecology. The Global Ocean Observation System is a project of the United Nation’s Intergovernmental Oceanographic Commission and unifies networks of scientists around the world. Adopting international standards and principles that are widely recognized in community practice will ensure a multilateral approach to the standardization of salmon ocean ecology data. 
...
### Media engagement
Social media should be utlized to the fullest extent to put forward scientific facts (including links to open-access papers), drive narratives of key topics to move pieces of information throuh the multidimensionsal fabric of guiding science intiatives.

Use an example from the BCSFA.

# Data Strategy
There needs to be a long-term strategy to effectively engage important stakeholders and deepen the impact of data mobilization. Community development is critical for the IYS-OOS to be succsessful. Open Science. Repeatability. Reproducibility. FAIR Data. What is copyright? Public work. Who is the public? Equality and openness; major rebalance of power required. Strategy ought to be modeled inline with UN objectives. Deepening Engagement and Impact; 2) System Integration and Delivery; and 3) Building for the Future.
