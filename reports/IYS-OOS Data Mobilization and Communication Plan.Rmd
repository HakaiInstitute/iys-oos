...
After researchers are identified for the various research groups, it is imperative that communications are established quickly and the DMAC, or the information in the DMAC, distributed as well. Both the names/organizations are required. I think it's important to identify each of the science disciplines for the 2022 High Seas Expedition, understand under which Research Group this falls, and how this ties in with the GOOS EOVs so that key variables can be identified or defined prior to the expedition. 
