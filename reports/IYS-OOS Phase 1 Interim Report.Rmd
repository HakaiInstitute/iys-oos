...
The development of the data model will rely heavily on input from expedition Chief Scientists, Scientists, project affiliated Scientists, Professors, and others. Within each scientific domain planned for the 2021 cruise, there should be representation in an adhoc working group tasked with determining international data standards that apply to their domain of expertise
